...
#if defined(ARTIO_MPI) && !defined(ARTIO_POSIX)
...
int artio_file_get_endian_swap_tag_i(artio_fh *handle) {
    return handle->mode & ARTIO_MODE_ENDIAN_SWAP;
}
